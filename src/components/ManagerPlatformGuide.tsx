...
const managerModules: ManagerModule[] = [
  ...
  },
  {
    ...
    category: "showcase",
    icon: Building2,
    title: "سازنده صفحه حرفه‌ای آموزشگاه",
    desc: "کنترل کامل هویت، محتوای عمومی و تمام بخش‌های صفحه اختصاصی آموزشگاه.",
    ...
    items: [
      ...
      "ثبت شعار، کاور عریض، ویدئوی معرفی، تور مجازی، تاریخچه، ماموریت و چشم‌انداز",
      "مدیریت مزیت‌ها، امکانات، اطلاعات مسیر، شبکه‌های اجتماعی و آمار تکمیلی",
      "مدیریت نمونه‌کارها، داستان موفقیت، اخبار، سوالات متداول، مجوزها و شرکای تجاری",
      "تنظیم نمودار کیفیت، مشاوران و زمان‌های رزرو مشاوره",
      "مشاهده و پیگیری درخواست‌های ثبت‌نام سریع و مشاوره",
      "آپلود و برش عکس پروفایل برای هدر و نوار استوری",
      "انتشار استوری تصویری یا ویدئویی با انقضای خودکار",
      "مدیریت نمونه‌های اولیه و جایگزینی یا حذف آن‌ها بدون دست‌زدن به داده‌های قدیمی",
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto mb-8 max-w-4xl text-center">
          ...
          <p className="mx-auto max-w-3xl text-sm leading-7 text-slate-300 md:text-base md:leading-8">
            این بخش بر اساس امکانات فعال پنل مدیر، پنل هنرجو، مدیریت کل و صفحات عمومی فَنیکسو تنظیم شده است؛
