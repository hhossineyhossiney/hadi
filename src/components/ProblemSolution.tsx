...
const problems = [
  {
    icon: Users2,
    title: "مدیریت پراکنده هنرجویان",
    desc: "دفترچه، اکسل، پیامک، واتساپ — همه چیز جداست و اطلاعات گم می‌شود.",
  },
  {
    icon: Megaphone,
    title: "تبلیغات ضعیف و بی‌هدف",
    desc: "هزینه تبلیغ می‌کنید ولی نمی‌دانید چند نفر ثبت‌نام کردند.",
  },
  {
    icon: Clock,
    title: "اتلاف زمان روی کارهای تکراری",
    desc: "ثبت‌نام دستی، گواهی چاپی، پیگیری تلفنی — ساعت‌ها وقت هدر می‌رود.",
  },
  {
    icon: BarChart3,
    title: "نبود گزارش دقیق و لحظه‌ای",
    desc: "درآمد، بدهی، حضور، پیشرفت هنرجو — هیچ نمای کلی وجود ندارد.",
  },
];

const solutions = [
  "پنل یکپارچه برای هنرجویان، دوره‌ها، پرداخت‌ها و ارتباطات",
  "کانال تبلیغاتی داخلی + استوری + بنر هدفمند + گزارش کلیک",
  "ثبت‌نام آنلاین خودکار، گواهی دیجیتال با QR، پیامک هوشمند",
  "داشبورد لحظه‌ای با نمودار درآمد، اقساط، حضور و رضایت",
];
