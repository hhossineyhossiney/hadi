...
import {
  Sparkles, ArrowLeft, Rocket, Bot, Brain, GraduationCap,
  Calculator, BookOpenCheck, Layers, CalendarDays, Mic2, Target, AlertTriangle,
  HeartHandshake, Repeat, Compass,
  FileText, HelpCircle, ClipboardCheck, CheckCheck, UserCheck, BarChart2,
  Presentation, Video, Volume2, Users,
  UserX, TrendingUp, DollarSign, Megaphone, Smile, Contact2, PhoneCall,
  MessageCircle, Instagram, Flag, Mail, Send,
  PenLine, Globe, Search, ImageIcon, Palette, LayoutGrid,
  Film, Camera, Wand2, Clapperboard,
  BarChart3, LineChart, PiggyBank, UserSearch, Trophy, Swords, FileSearch,
  Headphones, AudioLines, Speaker, Languages, Mic,
  Workflow, Award, BellRing, CalendarClock, Undo2, Timer,
  type LucideIcon,
} from "lucide-react";
...
const SECTIONS: Section[] = [
  {
    ...
    features: [
      ...
      { icon: CalendarDays, title: "برنامه مطالعه شخصی‌سازی", desc: "بر اساس تعداد ساعت آزادت، برنامه مطالعه بهینه بساز" },
      { icon: Mic2, title: "معلم صوتی", desc: "با هوش صحبت کن، سوال بپرس، توضیح صوتی حرفه‌ای بگیر" },
      ...
      { icon: HeartHandshake, title: "مربی روزانه یادگیری", desc: "هر روز صبح چالش کوتاه، هدف روز و تشویق شخصی دریافت کن" },
  ...
  },
  {
    ...
    features: [
      ...
      { icon: CheckCheck, title: "تصحیح خودکار برگه", desc: "برگه رو عکس بگیر، AI نمره و بازخورد دقیق برای هر سوال میده" },
      { icon: UserCheck, title: "هوش حضور و غیاب", desc: "الگوی غیبت هر هنرجو تحلیل و ریسک ترک‌تحصیل بهت اعلام میشه" },
      { icon: BarChart2, title: "تحلیل کیفیت دوره", desc: "بر اساس بازخورد و نمرات، نقاط قوت و ضعف دوره‌ت رو شناسایی می‌کنه" },
      ...
      { icon: BookOpenCheck, title: "منتور تدریس", desc: "پس از هر جلسه، بازخورد سازنده درباره روش تدریست بگیر" },
    ],
  },
  {
    id: "centers",
    ...
    features: [
      ...
      { icon: Contact2, title: "CRM هوشمند", desc: "لیدها رو خودکار امتیازدهی و اولویت‌بندی می‌کنه" },
      { icon: PhoneCall, title: "دستیار فروش تلفنی", desc: "اسکریپت مکالمه، پاسخ اعتراض و بستن فروش رو در لحظه پیشنهاد میده" },
      { icon: MessageCircle, title: "اتوماسیون واتساپ", desc: "پیام خوش‌آمد، پیگیری و یادآوری خودکار به تمام مخاطبین" },
      { icon: Instagram, title: "تولید محتوای اینستاگرام", desc: "پست، استوری و ریلز جذاب متناسب با هویت برند آموزشگاه" },
  ...
  },
  {
    ...
    icon: Palette,
    features: [
      { icon: PenLine, title: "تولید مقاله بلاگ", desc: "مقاله ۱۵۰۰ کلمه‌ای SEO محور با تیتر، سرتیتر و متا در ۲ دقیقه" },
      ...
      { icon: ImageIcon, title: "طراح بنر تبلیغاتی", desc: "بنر وب و شبکه اجتماعی با متن جذاب و ترکیب رنگ حرفه‌ای" },
      ...
      { icon: Clapperboard, title: "پرامپت‌ساز ویدیو", desc: "پرامپت برای Sora، Runway و Kling با جزئیات سینمایی" },
    ],
  },
  {
    id: "bi",
    ...
    features: [
      ...
      { icon: UserSearch, title: "تحلیل هنرجو", desc: "کوهورت، LTV و رفتار خرید هنرجویان" },
      { icon: Trophy, title: "عملکرد اساتید", desc: "رتبه‌بندی اساتید بر اساس رضایت، نتیجه و درآمدزایی" },
      { icon: Swords, title: "تحلیل رقبا", desc: "با تحلیل قیمت، دوره و بازار، جایگاه رقابتی خودت رو ببین" },
      { icon: FileSearch, title: "گزارش هوشمند", desc: "گزارش خودکار هفتگی/ماهانه با insight و پیشنهاد اقدام" },
    ],
  },
  {
    id: "voice",
    ...
    features: [
      ...
      { icon: AudioLines, title: "تبدیل گفتار به متن", desc: "صدای فارسی و انگلیسی رو با دقت بالا به متن تبدیل کن" },
  ...
  },
  {
    ...
    icon: Workflow,
    features: [
      { icon: Workflow, title: "طراح فرآیند", desc: "فرآیندهای پیچیده رو با drag & drop خودکار کن" },
      { icon: Award, title: "صدور گواهی خودکار", desc: "پس از تکمیل دوره، گواهی با QR و امضا خودکار صادر میشه" },
      { icon: BellRing, title: "اعلان هوشمند", desc: "پیام درست، به فرد درست، در زمان درست — بدون spam" },
      { icon: CalendarClock, title: "زمان‌بند AI", desc: "کلاس‌ها، جلسات و رویدادها بر اساس ظرفیت خودکار زمان‌بندی میشن" },
      { icon: Undo2, title: "پیگیری خودکار", desc: "لیدها و مشتریان بلاتکلیف رو خودکار پیگیری کن" },
      { icon: Timer, title: "یادآوری هوشمند", desc: "یادآوری قسط، جلسه و آزمون به هنرجو و مدیر" },
      { icon: Contact2, title: "اتوماسیون CRM", desc: "تبدیل لید به مشتری با فرآیندهای هوشمند و شخصی‌سازی" },
    ],
  },
];
