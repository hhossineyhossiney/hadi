...
فَنیکسو هم‌اکنون یک محصول عملیاتی با Next.js، PostgreSQL، پنل هنرجو، پنل آموزشگاه، مدیریت کل، فروش آنلاین، چت، آزمون، تکلیف، مالی و هوش مصنوعی است. بنابراین بازنویسی یک‌باره از صفر، ریسک ازبین‌رفتن داده و توقف سرویس دارد.
